...
금융권 SI 환경에서 4년간 K-Bank, 카카오뱅크 등 금융 시스템 고도화 프로젝트를 수행했습니다.
...
금융권 회계·예산·IFRS 시스템 고도화 프로젝트를 주로 수행했습니다.
초기부터 화면·배치·인터페이스를 포괄하는 풀사이클 개발을 담당했고,
...
**인증·권한 체계 설계**
- JWT 즉시 무효화 불가 리스크를 고려, 서버 통제 가능한 세션 기반 인증 방식 선택
